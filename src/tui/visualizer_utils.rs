...
///
/// Vendored unmodified from audio-viz-tui/src/visualizer_utils.rs except for
/// the import path below. Keep in sync with the original when re-syncing
/// installed TUI visualizers.

use crate::tui::visualizer::{FFT_SIZE, SAMPLE_RATE};
