...
// Installed TUI visualizer — source copied verbatim from
// audio-viz-tui/src/visualizers/effects/tempest.rs; only the import paths
// below and register() at the bottom differ (see src/term/mod.rs).
use rand::Rng;
...
use crate::tui::visualizer_utils::{
...
pub fn register() -> Vec<Box<dyn crate::visualizer::Visualizer>> {
    crate::term::TermViz::adapt(vec![Box::new(TempestViz::new(""))])
}
